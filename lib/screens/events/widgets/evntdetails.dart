        ...
        child: SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Stack(children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  AnimatedContainer(
                                    ...
                                    child: Container(
                                      height:
                                          (isMobile) ? 150 : size.height * 0.4,
                                      width:
                                          (isMobile) ? 250 : size.width * 0.4,
                                      decoration: BoxDecoration(
                                        color: Colors.white,
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: (isMobile) ? 70 : size.width * 0.10),
                  child: Align(
      ...
      children: [
        LinearGradientText(
          child: Text(
            text,
            style: TextStyle(
                fontSize: (isMobile) ? 10 : 40, fontWeight: FontWeight.bold),
          ),
        ),
        Text(
          theme,
